    ...
    <main className="min-h-screen bg-slate-950 text-white">
      ...
      <section className="max-w-5xl mx-auto px-6 py-24 text-center">
        <span className="inline-flex items-center rounded-full border border-fuchsia-800 bg-fuchsia-950/50 px-3 py-1 text-xs font-medium text-fuchsia-300">
          Built by someone tired of "the sale went great" being a lie
        </span>
        <h1 className="mt-6 text-4xl sm:text-6xl font-black tracking-tight leading-tight">
          Your last promo looked great. <span className="text-fuchsia-500">Did it actually make money?</span>
        </h1>
        <p className="mt-6 mx-auto max-w-2xl text-lg text-slate-400">
          Here's the thing nobody tells you at a DTC brand: revenue during a sale goes up almost every time. That's
          not the question. The question is whether the margin survived the discount, whether people would've bought
          anyway, and whether you just cannibalized next month's sales to pull off this month's spike. We built
          PromoMarginTruth to answer that, promo by promo, in real dollars, and tell you flat out which ones to kill.
        </p>
        ...
        <p className="mt-4 text-sm text-slate-500">Everything's free while you're signed in. Load the sample BFCM teardown and poke around, it only takes a click.</p>
      </section>

      <section className="border-y border-slate-800 bg-slate-900/30 px-6 py-16">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl font-bold text-center">A record sales week can still be a bad week</h2>
          <div className="mt-10 grid gap-6 sm:grid-cols-3 text-left">
            <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
              <div className="text-fuchsia-400 font-semibold">The discount ate the margin</div>
              <p className="mt-2 text-sm text-slate-400">A 30%-off sitewide event posts a record revenue number while quietly torching contribution margin on the customers who were going to pay full price anyway.</p>
            </div>
            <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
              <div className="text-fuchsia-400 font-semibold">Half those sales weren't incremental</div>
              <p className="mt-2 text-sm text-slate-400">A chunk of buyers would've checked out at full price regardless. They got a discount they didn't need, and almost nobody bothers to compute that baseline.</p>
            </div>
            <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
              <div className="text-fuchsia-400 font-semibold">You stole from next month</div>
              <p className="mt-2 text-sm text-slate-400">Full-price demand got pulled forward, or stolen from a neighboring SKU. A spreadsheet just can't hold this analysis together.</p>
            </div>
          </div>
          <p className="mt-8 text-center text-slate-400">
            So the same losing promos run again next cycle, and the CFO just watches blended margin quietly shrink
            with no specific promo anyone can point to and cut.
          </p>
        </div>
      </section>

      <section className="max-w-6xl mx-auto px-6 py-20">
        <h2 className="text-2xl font-bold text-center">What we actually built</h2>
        <p className="mt-2 text-center text-slate-400">Straightforward analytics over the order data you upload, connect, or generate as a sample.</p>
      ...
      <section className="border-t border-slate-800 px-6 py-20 text-center">
        <h2 className="text-3xl font-bold">Stop guessing which promos are worth it</h2>
        <p className="mt-4 mx-auto max-w-xl text-slate-400">
          Walk into your next margin review with a real retrospective and an actual dollar figure for what to fix.
        </p>
